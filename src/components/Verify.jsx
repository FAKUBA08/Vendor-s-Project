...
function Verify() {
    ...
    const checkVerificationStatus = async () => {
        try {
            const response = await axios.post('https://vendors-node.onrender.com/api/auth/check-verification', { email });
    ...
    const handleResendVerification = async () => {
        ...
        try {
            ...
            const response = await axios.post('https://vendors-node.onrender.com/api/auth/resend-verification', { email });
